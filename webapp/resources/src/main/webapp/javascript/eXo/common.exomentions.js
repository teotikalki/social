...
// keep committed id: e7afc555114f27e20acc343b35c56e609958c534
  ...
  $.fn.commonMentions = function(method, settings) {
    ...
    return this.each(function() {
      var instance = $.data(this, 'commonMentions') || $.data(this, 'commonMentions', new eXoMentions(settings));
