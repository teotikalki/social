...
public class UIDefaultActivityComposer extends UIActivityComposer {
  ...
  public ExoSocialActivity onPostActivity(PostContext postContext, String postedMessage) throws Exception {
    ...
    if (postContext == UIComposer.PostContext.SPACE) {
      ...
      activity = new ExoSocialActivityImpl(Utils.getViewerIdentity().getId(), SpaceActivityPublisher.SPACE_APP_ID, HTMLSanitizer.sanitize(postedMessage), null);
      ...
      activity = new ExoSocialActivityImpl(Utils.getViewerIdentity().getId(), PeopleService.PEOPLE_APP_ID, HTMLSanitizer.sanitize(postedMessage), null);
      activity.setType(UIDefaultActivity.ACTIVITY_TYPE);
      //
