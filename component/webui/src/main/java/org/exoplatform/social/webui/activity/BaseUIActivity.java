...
//    activity = Utils.getActivityManager().getActivity(activity.getId());
  ...
  public boolean isActivityDeletable() throws SpaceException {
    ...
    if (Utils.getViewerIdentity().equals(getOwnerIdentity()) || Utils.getViewerIdentity().getRemoteId().equals(activity.getStreamOwner()) || userACL.isUserInGroup(userACL.getAdminGroups())) {
      return true;
    }
